...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/paul/toolchain/build/builds/destdir/aarch64-unknown-linux-gnu/arm-none-eabi/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
